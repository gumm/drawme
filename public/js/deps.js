...
goog.addDependency('../../../drawme/base/views/persistent.js', ['app.base.view.Persistent'], ['app.base.EventType', 'app.base.panel.Persistent', 'app.user.EventType', 'bad.ui.View', 'bad.utils', 'contracts.urlMap', 'goog.Uri'], false);
goog.addDependency('../../../drawme/drawme.js', ['drawme'], ['bad.Net', 'drawme.Site', 'goog.net.XhrManager'], false);
goog.addDependency('../../../drawme/site.js', ['drawme.Site'], ['app.base.view.Home', 'app.base.view.Persistent', 'app.user.view.Login', 'bad.UserManager', 'bad.ui.EventType', 'bad.ui.Layout', 'contracts.urlMap', 'goog.Uri', 'goog.array', 'goog.dom', 'goog.dom.classes', 'goog.events.EventHandler'], false);
...
goog.addDependency('../../../drawme/user/views/account.js', ['app.user.view.Account'], ['app.BasicView', 'app.base.EventType', 'app.doMap', 'app.org.panel.List', 'app.user.EventType', 'app.user.panel.DeleteAccount', 'app.user.panel.NavPanel', 'app.user.panel.SignUp', 'bad.ui.Panel', 'bad.utils', 'goog.Uri', 'goog.dom', 'goog.events.EventType'], false);
goog.addDependency('../../../drawme/user/views/loginview.js', ['app.user.view.Login'], ['app.BasicView', 'app.user.EventType', 'app.user.panel.Login', 'app.user.panel.LostPassword', 'app.user.panel.ResetPassword', 'app.user.panel.SignUp', 'bad.ui.EventType', 'bad.ui.Panel', 'bad.utils', 'contracts.urlMap', 'goog.Uri'], false);
