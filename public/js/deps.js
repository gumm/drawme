...
goog.addDependency('../../../drawme/base/views/persistent.js', ['app.base.view.Persistent'], ['app.base.EventType', 'app.base.ViewEventType', 'app.base.panel.Persistent', 'app.user.EventType', 'bad.ui.View', 'bad.utils', 'contracts.urlMap', 'goog.Uri', 'goog.object'], false);
goog.addDependency('../../../drawme/drawme.js', ['drawme'], ['bad.Net', 'drawme.Site', 'goog.net.XhrManager'], false);
goog.addDependency('../../../drawme/site.js', ['drawme.Site'], ['app.base.view.Home', 'app.base.view.Persistent', 'app.user.view.Login', 'bad.UserManager', 'bad.ui.Layout', 'contracts.urlMap', 'goog.Uri', 'goog.array', 'goog.dom', 'goog.dom.classes', 'goog.events.EventHandler'], false);
goog.addDependency('../../../drawme/user/constants.js', ['app.user.EventType'], ['bad.utils'], false);
goog.addDependency('../../../drawme/user/panels/deleteaccountform.js', ['app.user.panel.DeleteAccount'], ['app.user.EventType', 'bad.ui.Form', 'bad.utils', 'goog.dom.forms', 'goog.uri.utils'], false);
...
goog.addDependency('../../../drawme/user/views/account.js', ['app.user.view.Account'], ['app.BasicView', 'app.base.EventType', 'app.org.panel.List', 'app.user.EventType', 'app.user.panel.DeleteAccount', 'app.user.panel.NavPanel', 'app.user.panel.SignUp', 'bad.ui.Panel', 'bad.utils', 'goog.Uri', 'goog.dom', 'goog.events.EventType'], false);
